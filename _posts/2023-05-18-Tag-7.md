...
Als Alternativen zu Openrefine gibt es beispielsweise (<a href="https://metafacture.org/">Metafacture</a>) oder (<a href="https://metafacture.org/">Catmandu</a>). Metafracutre ist eine Open Source Software und wird auf Github gehostet. Die Hauptprogrammiersprache ist Java. Es stehen eine Menge Module und einige Plugin Packages zur Verfügung. Bei den Plugin Packages so beispielsweise für SQL, MongoDB, Mediawiki, Hadoop-Cluster oder Lucene.
